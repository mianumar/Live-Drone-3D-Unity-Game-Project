        ...
        void OnGUI()
            {
                if (mobile_turned_on == true)
                {
                    ...
                    float scaleFactor = 0.7f; // Scale to 50% of the original size

                    // Scale down the rectangles
                    Rect scaledWRect = new Rect(wRect.x, wRect.y, wRect.width * scaleFactor, wRect.height * scaleFactor);
                    Rect scaledSRect = new Rect(sRect.x, sRect.y, sRect.width * scaleFactor, sRect.height * scaleFactor);
                    Rect scaledARect = new Rect(aRect.x, aRect.y, aRect.width * scaleFactor, aRect.height * scaleFactor);
                    Rect scaledDRect = new Rect(dRect.x, dRect.y, dRect.width * scaleFactor, dRect.height * scaleFactor);

                    Rect scaledIRect = new Rect(iRect.x, iRect.y, iRect.width * scaleFactor, iRect.height * scaleFactor);
                    Rect scaledJRect = new Rect(jRect.x, jRect.y, jRect.width * scaleFactor, jRect.height * scaleFactor);
                    Rect scaledKRect = new Rect(kRect.x, kRect.y, kRect.width * scaleFactor, kRect.height * scaleFactor);
                    Rect scaledLRect = new Rect(lRect.x, lRect.y, lRect.width * scaleFactor, lRect.height * scaleFactor);

                    // Draw the scaled textures
                    DrawGUI.DrawTexture(scaledWRect.x, scaledWRect.y, scaledWRect.width, scaledWRect.height, forward_button_texture);
                    DrawGUI.DrawTexture(scaledSRect.x, scaledSRect.y, scaledSRect.width, scaledSRect.height, backward_button_texture);
                    DrawGUI.DrawTexture(scaledARect.x, scaledARect.y, scaledARect.width, scaledARect.height, leftward_button_texture);
                    DrawGUI.DrawTexture(scaledDRect.x, scaledDRect.y, scaledDRect.width, scaledDRect.height, rightward_button_texture);

                    DrawGUI.DrawTexture(scaledIRect.x, scaledIRect.y, scaledIRect.width, scaledIRect.height, upwards_button_texture);
                    DrawGUI.DrawTexture(scaledJRect.x, scaledJRect.y, scaledJRect.width, scaledJRect.height, rotation_left_button_texture);
                    DrawGUI.DrawTexture(scaledKRect.x, scaledKRect.y, scaledKRect.width, scaledKRect.height, downwards_button_texture);
                    DrawGUI.DrawTexture(scaledLRect.x, scaledLRect.y, scaledLRect.width, scaledLRect.height, rotation_right_button_texture);
                }
            }
