...
#if UNITY_ANDROID
    string appKey = "21472d025";
    string bannerAdUnitId = "952gcfpgrms5vtxp";
    string interstitialAdUnitId = "c6nxmd88zah0jdvc";
#elif UNITY_IPHONE
    string appKey = "213271c05";
    string bannerAdUnitId = "utfcxdi3lgtoj5aq";
    string interstitialAdUnitId = "dx0vied7jt9tlg2j";
#else
